...
public class ExcelService {
    ...
    public void getTemplate(String type, HttpServletResponse response) {
        ...
        switch (t) {
            ...
            case "event" -> {
                // 表格2 布局（与 EventService.parseTable2Row 列完全对齐）：
                // A代码/B项目/C是否田径/D道次(田赛0)/E性别/F年级组/G是否团体/H团体人数/
                // I并数(项目内并发:径赛填1=仅1人串行,2+=可并行,取决于场地数)/J场地/K最大用时/L间隔/
                // M顺序号/N并行捆绑组(同字母同批并行)/O场地编码(可与主场地并行,如游泳馆)
                fileName = "项目表导入模板_表格2.xlsx";
                sheet.add(List.of("代码","项目","是否田径","道次","性别","年级组","是否团体","团体人数",
                        "并数/项目内并发","场地","最大用时(分)","间隔(分)","顺序号","并行捆绑组","场地编码"));
                sheet.add(List.of("100M","100米","是","8","男子组","高一年级","否","0","8","田径场","20","10","1","","TRACK"));
                sheet.add(List.of("4X100M","4×100米接力","是","8","男子组","高一年级","是","4","8","田径场","30","15","2","","TRACK"));
                sheet.add(List.of("TY_F","跳远(女子)","否","0","女子组","高一年级","否","0","1","田赛A区","90","10","3","A","FIELD_A"));
                sheet.add(List.of("SWIM_M","50米蛙泳(男子)","是","8","男子组","高一年级","否","0","4","游泳馆","25","10","4","","SWIM"));
            }
            default -> {
                fileName = "导入模板.xlsx";
