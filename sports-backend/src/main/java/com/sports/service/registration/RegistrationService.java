package com.sports.service.registration;
...
public class RegistrationService {
    ...
    public Registration create(Long athleteId, Long eventId) {
        ...
        if (!com.sports.common.util.GenderUtil.matches(event.getGenderLimit(), athlete.getGender()))
    ...
    private List<Map<Integer, String>> readRows(InputStream in, String filename) throws IOException {
        ...
        if (filename != null && filename.toLowerCase().endsWith(".csv")) {
            String text = com.sports.common.util.FileEncoding.decode(in);
