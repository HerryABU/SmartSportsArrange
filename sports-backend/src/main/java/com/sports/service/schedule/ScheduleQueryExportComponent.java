...
public class ScheduleQueryExportComponent {
    ...
    public void export(HttpServletResponse response) {
        ...
        String fileName = "项目赛程表_" + com.sports.common.util.ExportNaming.stage(afterSecond)
        ...
        try (OutputStream out = response.getOutputStream()) {
            ...
            for (EventSchedule s : schedules) {
                ...
                String roundLabel = com.sports.common.util.RoundLabelUtil.label(
    ...
    public Map<String, Object> buildResult() {
        ...
        List<Map<String, Object>> items = schedules.stream().map(s -> {
            ...
            m.put("roundLabel", com.sports.common.util.RoundLabelUtil.label(
