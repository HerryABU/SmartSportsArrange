...
import com.sports.controller.student.StudentController;

/**
 * 学生端业务逻辑（M1 修复：从 StudentController 抽取，避免 Controller 越层 + @Transactional 标在 Controller 类上）。
 *
 * <p>学生端为只读聚合查询（首页 / 项目浏览 / 我的赛程 / 我的成绩），事务统一收敛在 Service 层（只读）。</p>
 */
@Slf4j
@Service
