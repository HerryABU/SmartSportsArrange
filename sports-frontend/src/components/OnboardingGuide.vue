    ...
    <template #header>
      <div class="guide-head">
        ...
        <div>
          ...
          <div class="guide-sub">跟着下面 8 步，即可完成一届运动会的初始化与智能编排</div>
        </div>
      </div>
    </template>
...
const steps = [
  ...
  { title: '导入运动员名单', desc: '批量导入学生花名册，自动生成运动员并分配号码簿。', to: '/teacher/athletes' },
  { title: '添加比赛项目（表格2）', desc: '用「表格2」模板导入：含顺序号、项目内并发、并行捆绑组等列，支持 Excel/CSV。', to: '/teacher/events' },
  ...
  { title: '道次编排', desc: '对已审核报名自动分组分道，预览/批量编排/手动调整，并可生成预赛。', to: '/teacher/arrange' },
